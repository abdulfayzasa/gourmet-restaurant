...
import hamburger_header from '../Images/hamburger-header.jpg'
import tabelsetting from '../Images/tablesetting.jpg'
        ...
        return (
            <div>
                ...
                <div className="w3-row w3-padding-64" id="about">
                    ...
                    <img src={hamburger_header} className="w3-round w3-image w3-opacity-min" alt="Table Setting" width="600" height="750"/>
                    </div>
                ...
                <div className="w3-row w3-padding-64" id="menu">
                    ...
                    <div className="w3-col l6 w3-padding-large">
                    <img src={tabelsetting} className="w3-round w3-image w3-opacity-min" alt="Menu" style={{"width":"100%"}}/>
                    </div>
                </div>
